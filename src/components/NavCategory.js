...
const NavCategory = (props) => {
    ...
    return (
        <div className="hidden z-50 cursor-default max-w-[1200px] absolute top-[44px] left-0 right-0 m-auto p-[15px] bg-white shadow-lg group-hover/navCategory:flex flex-1">
